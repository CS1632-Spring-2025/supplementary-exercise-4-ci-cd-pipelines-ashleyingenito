...
public class RentACatUnitTest {
	...
	public void testGetCatNullNumCats0() {
		...
		try {
			...
			assertNull("getCat(2) should return null when there are no cats", result);
	...
	public void testGetCatNumCats3() {
		...
		try {
			...
			getCatMethod.setAccessible(true);
			Cat result = (Cat) getCatMethod.invoke(r, 2);
			assertNotNull("getCat(2) should return a valid Cat object", result);
	...
	public void testListCatsNumCats0() {
		// TODO: Fill in
		assertEquals("listCats() should return an empty string when there are no cats", "", r.listCats());
	}
	...
	public void testListCatsNumCats3() {
		...
		assertEquals("listCats() should return a formatted list of cats","ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n", r.listCats());
	}
	...
	public void testRenameFailureNumCats0() {
		// TODO: Fill in
		assertFalse("renameCat should return false when no cats exist", r.renameCat(2, "Garfield"));
    	assertEquals("Invalid cat ID." + newline, out.toString());
	}
	...
	public void testRenameNumCat3() {
		...
		assertTrue("renameCat should return true when renaming is successful", r.renameCat(2, "Garfield"));
	...
	public void testRentCatNumCats3() {
		...
		assertTrue("rentCat should return true if the cat is available for rent", r.rentCat(2));
	...
	public void testRentCatFailureNumCats3() {
		...
		assertFalse("rentCat should return false if the cat is already rented", r.rentCat(2));
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue("returnCat should return true when a rented cat is returned", r.returnCat(2));
	...
	public void testReturnFailureCatNumCats3() {
		...
		assertFalse("returnCat should return false if the cat was not rented", r.returnCat(2));
